...
class SignupLesseePage extends StatefulWidget {
  const SignupLesseePage(
      {Key? key,
  ...
  @override
  _SignupLesseePageState createState() => _SignupLesseePageState();
}

class _SignupLesseePageState extends State<SignupLesseePage> {
  String firstName = '';
  String lastName = '';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text(
              'Provide those additional information for Lessee.',
